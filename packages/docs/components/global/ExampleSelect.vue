<template>
  <div>
    ...
    <div v-if="section === 'custom'">
      <aq-select v-model="value" :custom="true" :options="arr">
      </aq-select>
    </div>

    <div v-if="section === 'optionLabel'">
      <aq-select v-model="value" :custom="true" :options="options" option-label="name" label="Jimmy Name">
      </aq-select>
    </div>
  </div>
</template>
