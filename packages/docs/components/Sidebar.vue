      ...
      <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 pb-4 bg-white overflow-y-auto">
        ...
        <div class="mt-5 flex-grow flex flex-col">
          <nav class="flex-1 px-2 bg-white">
            <div>
              <a href="#"
                class="group w-full flex items-center pl-2 py-2 text-sm leading-5 font-medium text-gray-900 rounded-md bg-gray-100 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
                <!-- Heroicon name: home -->
                <svg class="mr-3 h-6 w-6 text-gray-600 transition ease-in-out duration-150"
            ...
            <div>
              ...
              <div class="mt-1 space-y-1">
                <nuxt-link class="nav-item" to="/docs/button">Button</nuxt-link>
                <a href="#"
                  class="nav-item">
                  Members
                </a>
...
<style lang="postcss" scoped>
  .nav-item {
    @apply w-full flex items-center pl-11 pr-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md transition ease-in-out duration-150;
  }
